...
$user_query = mysqli_query($con, "SELECT username, password, security_question, security_answer FROM teachers WHERE teacher_id = '$teacher_id'") or die(mysqli_error($con));
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_settings'])) {
    ...
    if (empty($new_username)) {
        ...
        $check_query = mysqli_query($con, "SELECT teacher_id FROM teachers WHERE username = '$new_username' AND teacher_id != '$teacher_id'");
    ...
    if (empty($errors)) {
        ...
        $update_query = "UPDATE teachers SET $update_fields WHERE teacher_id = '$teacher_id'";

        if (mysqli_query($con, $update_query)) {
            $success = "Settings updated successfully.";
            $teacher['username'] = $new_username;
            $teacher['security_answer'] = $security_answer;
        } else {
            ...
            <div class="x_content">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" 
                           value="<?php echo htmlspecialchars($teacher['username']); ?>" readonly>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" 
                           value="<?php echo htmlspecialchars($teacher['security_question']); ?>" readonly>
                </div>

                <div class="form-group">
                    <label>Security Answer</label>
                    <input type="text" class="form-control" 
                           value="<?php echo htmlspecialchars($teacher['security_answer'] ?? ''); ?>" readonly>
                </div>
            </div>
        </div>
    </div>
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          ...
          <input type="text" name="security_answer" class="form-control" 
                 value="<?php echo htmlspecialchars($teacher['security_answer'] ?? ''); ?>" required>
        </div>
