...
if (isset($_POST['update11'])) {
    ...
    if ($error == 0) {
        ...
        $query = mysqli_query($con, "UPDATE book SET 
            ...
            status = '$status',
            book_image = '$image'
            WHERE book_id = '$id' ") or die(mysqli_error($con));
    } else {
    ...
    echo "<script>alert('Book successfully updated!'); window.location='book.php'</script>";
}
?>
