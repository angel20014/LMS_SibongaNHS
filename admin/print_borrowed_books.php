...
$query = "
    ...
    WHERE borrow_book.borrowed_status = 'borrowed'
";
...
<?php if (!empty($datefrom) && !empty($dateto)): ?>
    <p style="font-size:13pt; font-weight:bold; margin-left:28px;">
        Showing records from <span style="color:red;"><?php echo date("M d, Y", strtotime($datefrom)); ?></span> 
...
while ($return_row = mysqli_fetch_array($return_query)) {
    // Determine if borrower is student or teacher
...
<tr>
    ...
    <td style="text-transform: capitalize; text-align:center;"><?php echo $borrower_level; ?></td>
    <td style="text-transform: capitalize; text-align:center;"><?php echo $borrower_section; ?></td>
...
if ($return_count <= 0){
    echo '
        <tr>
            <td colspan="8" class="alert alert-danger text-center">No borrowed books found in this date range</td>
        </tr>
    ';
}
?>
