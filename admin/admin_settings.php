...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_settings'])) {
    ...
    if (empty($errors)) {
        ...
        $update_query = "UPDATE admin SET $update_fields WHERE admin_id = '$admin_id'";

        if (mysqli_query($con, $update_query)) {
            $success = "Settings updated successfully.";
            $admin['username'] = $new_username;
            $admin['security_answer'] = $security_answer;
        } else {
...
<div class="page-title">
    <div class="title_left">
        <h3><small>Home /</small> Admin Account Settings</h3>
    </div>
</div>
        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" 
                           value="<?php echo htmlspecialchars($admin['security_question']); ?>" readonly>
                </div>

                <div class="form-group">
                    <label>Security Answer</label>
                    <input type="text" class="form-control" 
                           value="<?php echo htmlspecialchars($admin['security_answer'] ?? ''); ?>" readonly>
                </div>
            </div>
        </div>
    </div>
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          ...
          <input type="text" name="security_answer" class="form-control" 
                 value="<?php echo htmlspecialchars($admin['security_answer'] ?? ''); ?>" required>
        </div>
