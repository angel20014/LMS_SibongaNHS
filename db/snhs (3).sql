...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 31, 2025 at 10:32 AM
...
(1, 'JESSA', ' UMBAY', 'PADILLO', 'CARCAR CITY, CEBU', '09077934408', 'What is your mother\'s maiden name?', 'jessa1', 'admin', 'admin', 'upload/1754872730_picture2.jpg', '2025-08-10 18:38:50');
...
(1, 'English Expressways : Second Year', 'Virginia F. Bermudez', 'Remedios F. Nery', 'Josephine M. Cruz', 'Milagrosa A. San Juan', '', 10, '2010', 'SD Publications, INC.', '978-971-0315-72-7', 2010, 'Old', 'SNHS1LMS', 'IMG_0019.JPG', '2025-08-17 01:06:46', 'Available', 1),
...
(3, 'Getting to Know-Puerto Rico', 'Frances Robins', '', '', '', '', 0, 'Coward-McCann', '1967', '', 0, 'Old', 'SNHS3LMS', '', '2015-12-14 01:21:47', 'Available', 3),
(4, 'Lotta on Troublemaker Street', 'Astrid Lindgren', '', '', '', '', 0, 'Aladdin Paperbacks', '2001', '0-689-84673-8', 1962, 'Replacement', 'SNHS4LMS', '', '2015-12-14 01:43:06', 'Available', 3),
...
(7, 'Gintong Pamana Wika at Panitikan - Ikalawang Taon', 'Lolita R. Nakpil', 'Leticia F. Dominguez', '', '', '', 4, '2000', 'SD Publications, INC.', '971-07-1885-1', 2000, 'Old', 'SNHS7LMS', 'IMG_0029 - Copy.JPG', '2015-12-14 02:20:36', 'Available', 3),
(14, 'Florante at Laura', 'Francisco Balagtas', '', '', '', '', 14, '', 'Francisco Balagtas', '12-12341', 1838, 'New', 'SNHS1004LMS', '', '2025-05-19 22:01:29', 'Available', 3);
...
CREATE TABLE `borrow_book` (
  ...
  `penalty_message` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
INSERT INTO `borrow_book` (`borrow_book_id`, `book_id`, `admin_id`, `student_id`, `teacher_id`, `date_borrowed`, `due_date`, `date_returned`, `borrowed_status`, `quantity`, `penalty_message`) VALUES
(1, 1, 0, 0, 1, '2025-08-30 12:47:27', '2025-08-31 12:47:27', '2025-08-31 16:07:11', 'Returned', 1, ''),
(2, 7, 0, 1, 0, '2025-08-30 12:49:46', '2025-08-31 12:49:46', '2025-08-31 16:15:58', 'Returned', 1, ''),
(3, 4, 0, 1, 0, '2025-08-31 16:31:59', '2025-09-01 16:31:59', NULL, 'Borrowed', 1, '');
...
INSERT INTO `penalties` (`id`, `borrow_book_id`, `borrower_name`, `borrower_type`, `book_title`, `due_date`, `message`, `created_at`, `status`) VALUES
(1, 2, 'LARRY ESPINOSA EMPASIS', 'Student', 'Gintong Pamana Wika at Panitikan - Ikalawang Taon', '2025-08-31 12:49:46', 'Dear LARRY ESPINOSA EMPASIS,\r\n\r\nThis is a reminder that your borrowed book \"Gintong Pamana Wika at Panitikan - Ikalawang Taon\" was due on 2025-08-31 12:49:46.\r\nPlease return it immediately.\r\n\r\nPenalty: You need to clean the library in 2 hours', '2025-08-31 06:42:19', 'Approved');
...
(1, 1, 1, 1, 0, 1, '2025-08-30 12:47:27', '2025-08-31 12:47:27', '2025-08-31 16:07:11', 'accepted', 1),
(2, 2, 7, 1, 1, 0, '2025-08-30 12:49:46', '2025-08-31 12:49:46', '2025-08-31 16:15:58', 'accepted', 1);
...
--
ALTER TABLE `borrow_book`
  MODIFY `borrow_book_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
